...
const Header = () => {
  ...
  return (
    <motion.header 
      ...
      className="sticky top-0 z-40 bg-slate-900/70 backdrop-blur-lg border-b border-white/10"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Button variant="ghost" onClick={toggleLanguage} className="font-bold text-slate-300 hover:text-white">
              {language === 'en' ? 'HE' : 'EN'}
            </Button>
            <NavLink to="/quote">
      ...
      {isMenuOpen && (
        <motion.div 
          ...
          className="md:hidden bg-slate-900/95 border-b border-slate-700"
        >
