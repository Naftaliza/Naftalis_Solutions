  ...
  return (
    <>
      ...
      <style>{`
        ...
        .a11y-dyslexia, .a11y-dyslexia * { font-family: 'Arial', sans-serif !important; letter-spacing: 0.05em; word-spacing: 0.1em; line-height: 1.8 !important; }
      ...
      <button
        ...
        aria-expanded={open}
        className="fixed bottom-20 right-4 z-50 bg-teal-600 hover:bg-teal-500 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg transition-colors focus:outline-none focus:ring-2 focus:ring-teal-300"
      >
      ...
      {open && (
        <div
          ...
          className="fixed bottom-36 right-4 z-50 bg-white border border-slate-200 rounded-2xl shadow-2xl p-5 w-64"
        >
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-slate-800 text-sm">Accessibility</h2>
            <button
          ...
          {/* Font size */}
          <div className="mb-4">
            <p className="text-xs text-slate-500 mb-2 font-medium">Text Size</p>
            <div className="flex items-center gap-2">
              ...
              >
                <ZoomOut size={14} aria-hidden="true" /> Smaller
              </button>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded border border-slate-200 text-slate-600 hover:bg-slate-50 text-xs"
              >
                <ZoomIn size={14} aria-hidden="true" /> Larger
              </button>
            </div>
          </div>
          ...
          <div className="space-y-2 mb-4">
            {[
              { key: 'contrast', label: 'High Contrast', icon: Sun },
              { key: 'grayscale', label: 'Grayscale', icon: Eye },
              { key: 'dyslexia', label: 'Dyslexia Font', icon: Type },
              { key: 'highlight', label: 'Highlight Links', icon: Eye },
